...
class Sidebar extends React.Component {
	...
	componentWillMount(){
		var that= this;
		console.log("will mount props",that.state.isAdmin);
		...
		var promise = isAdmin();
		  ...
		  promise.then(function(isAdmin){
			console.log("isAdmin sidebar",isAdmin);
			that.setState({isAdmin:isAdmin});
	...
	goToAddCompany(){
		console.log("ad company called")
		browserHistory.push('add-companies');
	}
                ...
                <div className="aside-inner">
                    <nav data-sidebar-anyclick-close="" className="sidebar">
                        ...
                        <ul className="nav">
							...
							<li className={ this.routeActive('add-companies') ? 'active' : '' }>
                                <div className={this.routeActive('add-companies') ? 'active nav-item' : 'nav-item '} title="add-companies" onClick={ this.toggleItemCollapse.bind(this, 'add-companies') }>
                                    <em className="icon-grid" onClick={this.goToAddCompany.bind(this)}></em>
                                  <span data-localize="sidebar.nav.table.add-companies" onClick={this.goToAddCompany.bind(this)}>Add Company</span> 
                                </div>
                            </li>
                            <li className={ this.routeActive('table-datatable') ? 'active' : '' }>
                                <div className={this.routeActive('table-datatable') ? 'active nav-item' : 'nav-item '} title="Tables" onClick={ this.toggleItemCollapse.bind(this, 'tables') }>
								
                                    <em className="icon-grid" onClick={this.goToDataTable.bind(this)}></em>
									  <span data-localize="sidebar.nav.table.DATATABLE" onClick={this.goToDataTable.bind(this)}>DataTables
											</span>
							</div>  
                            </li>
